...
- [ ] Initialize multi-package Cabal project structure:
  ```
  haskell-fhir/
  ├── cabal.project
  ├── fhir-types/
  ...
  └── fhir-server/
  ```
- [ ] Configure GHC 9.6+ with recommended extensions
...
- [ ] Download FHIR R4 specification bundle from hl7.org
...
- [ ] Design type-safe search parameters:
  ...
  ```
- [ ] Implement common search parameters (_id, _lastUpdated, etc.)
